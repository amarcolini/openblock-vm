...
class OpenBlockArduinoNano33BLEDevice extends OpenBlockArduinoUnoDevice{
    ...
    constructor (runtime, originalDeviceId) {
        ...
        // Create a new Arduino Nano 33 BLE peripheral instance
        this._peripheral = new ArduinoNano33BLE(this.runtime, this.DEVICE_ID, originalDeviceId);
    }
}

module.exports = OpenBlockArduinoNano33BLEDevice;
